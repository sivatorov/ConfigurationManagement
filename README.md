...
![Версия](https://img.shields.io/badge/Версия-0.3.9.69-1F6FEB) ![.NET](https://img.shields.io/badge/.NET-10-512BD4) ![Windows/WPF](https://img.shields.io/badge/Windows-WPF-4B8BBE) ![Linux/Avalonia](https://img.shields.io/badge/Linux-Avalonia%2011-8B5CF6) ![Лицензия](https://img.shields.io/badge/Лицензия-Open%20Source-success)
...
- **Временная блокировка приложения паролем** — защита интерфейса на время отсутствия пользователя: команда «Блокировка приложения» (меню «Утилиты», сразу после «Консоли администрирования серверов», можно назначить горячую клавишу) показывает модальное окно блокировки, и пока пароль не введён, приложение недоступно — окно разблокировки закрывается только верным паролем. Первый вызов предлагает задать пароль (хранится в виде PBKDF2-хэша).
